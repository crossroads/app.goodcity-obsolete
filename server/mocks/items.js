module.exports = function(app) {
  ...
  var offers = [ {"id": "2", "state": "draft", "collection_contact_name": 'TestOffer', "item_ids": ["1", "2", "3"] },
      {"id": "2", "state": "draft"} ];
  ...
  var items_json = {
    ...
    "images":[ {"id": 1,"image_url":"http://res.cloudinary.com/ddoadcjjl/image/upload/v1407764294/default/test_image.jpg","thumb_image_url":"http://res.cloudinary.com/ddoadcjjl/image/upload/c_fill,h_50,w_50/v1407764294/default/test_image.jpg","favourite":"true", "image_id":"1407764294/default/test_image.jpg"}],
  };
